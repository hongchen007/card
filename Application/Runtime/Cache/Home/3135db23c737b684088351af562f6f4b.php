...
<div class="code">
      <div class="codes">
         <img src="<?php echo ($info["weixin_headimgurl"]); ?>" class="img">
          <div class="txts">
              <span class="txt">我是<span><?php echo ($info["weixin_name"]); ?></span><br>向你推荐晓数点
              </span>
          </div>
      </div>
       <div id="qr"><img class="img-responsive" src="/card/Public/123/images/1505097531.jpg"></div>
       <div class="vip1">仅需<span>98</span>元扫描二维码加加入会员 终生受益</div>
