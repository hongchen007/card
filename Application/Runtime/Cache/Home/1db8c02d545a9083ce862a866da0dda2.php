...
<div class="code">
      ...
      <div class="particulars">
         ...
         <div id="detai_list">
              ...
              <p><span>1</span>贷款通道</p>
			  <ul>
				  <li>*集合提供全网贷款、信用卡办理通道，为会员提供自助申请办理平台。<li>
				  <li>* 为会员节省筹款时间，为会员节省金融中介相关费用 为会员节省购买市面金融一体机费用<li>
				  <li>*借助互联网发展趋势，为会员提供兼职赚钱机会，实现平台与会员互惠共赢。</li>
              </ul>
             <p><span>2</span>会员级别</p>
			   <ul>
			 
				 <li>*会员分为一级会员、二级会员和三级会员，三级会员之间的关系是逐级利润递减<li>
				 <li>*一级会员是由·	公司推广码或者是直接注册金卡会员进来的会员<li>
				 <li>*二级会员是一级会员推广的或者是注册的银卡会员进来的会员<li>
				 <li>*三级会员是二级会员推广进来的会员<li>
				</ul>
...
<ul class="footer">
    ...
    <li style="background: #FEEF8A;"><a href="javascript:;"><img src="/card/Public/123/images/li_39.jpg"><br><br>我要推广</a></li>
