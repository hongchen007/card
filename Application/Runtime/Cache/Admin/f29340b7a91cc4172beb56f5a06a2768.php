...
<body>
	<form action="<?php echo U('User/doeditser');?>" method="post" enctype="multipart/form-data" >
		<table class="table">
			<tr >
				<td class="th" colspan="2" >修改客服微信信息</td>
			</tr>
			<tr>
				<td>修改微信</td>
				<td><input type="text" name="weixin" value="<?php echo ($info['weixin']); ?>" /></td>
