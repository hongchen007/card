...
<body>
	<form action="<?php echo U('Link/doedit');?>" method="post" enctype="multipart/form-data" >
		<table class="table">
			<tr >
				<td class="th" colspan="2" >修改链接信息</td>
			</tr>
			<tr>
				<td>修改链接图片：</td>
			...
			<tr>
				<td>修改链接名称</td>
				<td><input type="text" name="bank_name" value="<?php echo ($info['bank_name']); ?>" /></td>
			</tr>
			<tr>
				<td>修改链接地址：</td>
				<td><input type="text" name="src" value="<?php echo ($info['src']); ?>" style="width:50%;" /></td>
			</tr>
			<tr>
				<td colspan="2">
