...
<body>
	<form action="<?php echo U('article/cardinsert');?>" method="post" enctype="multipart/form-data" >
		<table class="table">
			<tr >
				<td class="th" colspan="2">
					浏览信用卡知识文章
					<?php if(empty($info) == true): ?><span style="margin-left:80%;"><a href="<?php echo U('Article/cardadd');?>">添加文章</span><?php endif; ?>
				</td>
			</tr>
			<?php if(empty($info) == true): else: ?>
				...
				<tr>
					<td>状态</td>
					<td>
						<?php if($info['classes'] == 1): ?>已启用
						<?php else: ?>已禁用<?php endif; ?>
					</td>
				</tr>
				...
				<tr>
					<td>操作</td>
					<td>
						<?php if($info['classes'] == 1): ?><a href="/card/index.php/Admin/Article/cardedit/id/<?php echo ($info["id"]); ?>">修改</a>|
				            <a href="/card/index.php/Admin/Article/cardstop/id/<?php echo ($info["id"]); ?>">禁用</a>
				        <?php else: ?>
							<a href="/card/index.php/Admin/Article/cardedit/id/<?php echo ($info["id"]); ?>">修改</a> |
				            <a href="/card/index.php/Admin/Article/cardstart/id/<?php echo ($info["id"]); ?>">启用</a><?php endif; ?>
					</td>
				</tr><?php endif; ?>
		</table>
	</form>
