...
<body>
	<table class="table">
		<tr>
			<td class="th" colspan="20">客服列表</td>
		</tr>
		<tr class="tableTop">
			<th>客服ID</th>
			<th>客服微信</th>
		...
		<?php if(is_array($info)): foreach($info as $key=>$val): ?><tr>
			...
			<td>
	            <a href="/card/index.php/Admin/User/delservice/id/<?php echo ($val["id"]); ?>">删除</a> |
	            <a href="/card/index.php/Admin/User/editservice/id/<?php echo ($val["id"]); ?>">修改</a>
		    </td>
